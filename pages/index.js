      ...
      <main className=" bg-gradient-to-b from-white to-gray-100 px-10 md:px-20 lg:px-40 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-700">
        ...
        <section className="min-h-screen">
          ...
          <div className=" text-center p-10">
            ...
            <p className=" text-md py-5 leading-8 text-gray-800 md:text-xl max-w-2xl mx-auto dark:text-gray-200">
              After an 8-month{" "}
              <span className=" text-teal-400">Full-Stack</span> Bootcamp, I am
              ready for my first adventure in the industry. I am a discharged
              combat soldier from the Nahal brigade and my two most valuable
              qualities are <span className=" text-teal-400">hard work</span>{" "}
              and <span className=" text-teal-400">motivation</span>
            </p>
          </div>
          <div className=" text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
            <a
              href="https://github.com/RoeeKazma?tab=repositories"
              target={"_blank"}
              rel="noreferrer">
              <AiFillGithub />
            </a>
            <a
              href="https://www.linkedin.com/in/roee-kazma-a48858222/"
              target={"_blank"}
              rel="noreferrer">
              <AiFillLinkedin />
            </a>
            <a
              href="mailto:roeekazma@gmail.com"
              target={"_blank"}
              rel="noreferrer">
              <AiFillMail />
            </a>
          ...
          <div className=" text-center">
            ...
            <p className=" text-md py-2 leading-8 text-gray-600 max-w-2xl mx-auto md:text-xl dark:text-gray-200">
              ...
              <span className=" text-teal-400">
                {" "}
                I strive to learn more and constantly improve
              </span>
              , from the technological front to the social front. I take a lot
              of value and pride from the{" "}
              <span className=" text-teal-400">Bootcamp </span>and{" "}
              <span className=" text-teal-400">military service </span> I
              attended and I try to implement my learning into my work ethic.
            </p>
          ...
          <div className=" lg:flex gap-10">
            <div className=" text-center shadow-lg p-10 rounded-xl my-10 bg-gradient-to-tr from-blue-200 to-teal-200 lg:w-1/3">
              <Image
                ...
                alt="Design image"
              />
              <h4 className=" py-4 text-xl font-medium">
            ...
            <div className=" text-center shadow-lg p-10 rounded-xl my-10 bg-gradient-to-tr from-blue-200 to-teal-200 lg:w-1/3">
              ...
              <p className=" text-gray-800 py-1 ">
                ...
                , I am able to grasp new concepts quickly
              </p>
              <p className=" text-gray-800 py-1 ">
                <span className=" text-gray-900 font-medium ">Motivated</span>,
                Always seeking to be the best at what I do
              </p>
              <p className=" text-gray-800 py-1 ">
                <span className=" text-gray-900 font-medium ">
                  Great Team Player
                </span>
                , I know the value of having a good relationship with my
                co-workers
              </p>
            </div>
          </div>
        ...
        <section>
          <div className=" text-center">
            ...
            <p className=" text-md py-2 leading-8 text-gray-600 max-w-xl mx-auto md:text-xl dark:text-gray-200">
              Throughout my time at the bootcamp, we had to finish some projects
              to show our newly acquired skills. Here are some of them
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-500">
              *Hover over a project to see the technologies used in it and click
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap ">
            <div className="basis-1/3 flex-1">
              <a
                href="https://roee-kazma-25-12-2022.vercel.app/"
                target={"_blank"}
                rel="noreferrer"
                ...
                <div className="opacity-0 md:hover:opacity-100 duration-300 absolute inset-0 z-10 flex flex-col justify-center items-center text-6xl text-white font-semibold ">
                  <h1 className="text-white font-bold mb-5">Weather App</h1>
                  <p className=" text-blue-500 font-bold text-3xl">React</p>
                  <p className=" text-blue-400 font-bold text-3xl">Redux</p>
            ...
            <div className="basis-1/3 flex-1 ">
              <a
                href="https://github.com/RoeeKazma/React-Hotel-Project"
                target={"_blank"}
                rel="noreferrer"
                className=" group relative">
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a
                href="https://github.com/RoeeKazma/royal-crm"
                target={"_blank"}
                rel="noreferrer"
                className=" group relative">
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a
                href="https://github.com/RoeeKazma/Mardi-Gras"
                target={"_blank"}
                rel="noreferrer"
                className=" group relative">
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a
                href="https://github.com/RoeeKazma/kanban-LocalStorage/tree/WorkingBranch"
                target={"_blank"}
                rel="noreferrer"
                className=" group relative">
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a
                href="https://github.com/RoeeKazma/MP3-DOM"
                target={"_blank"}
                rel="noreferrer"
                className=" group relative">
                <Image
        ...
        <section>
          <div className=" flex flex-col text-center py-8 ">
            <h1 className=" text-xl font-burtons text-teal-600 dark:text-teal-400 ml-6 mb-2">
              Call Me : +972 52-8669118
            </h1>
            <p className="text-xl font-burtons text-teal-600 dark:text-teal-400  mb-2">
              This website was made using - NextJS and TailwindCSS
            </p>
          </div>
        </section>
      </main>
