  ...
  return (
    ...
    <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap ">
            <div className="basis-1/3 flex-1 ">
              <a href="https://github.com/RoeeKazma/React-Hotel-Project" target={"_blank"} className=' group'>
                <Image
            ...
            <div className="basis-1/3 flex-1">
            <a href="https://github.com/RoeeKazma/Mardi-Gras" target={"_blank"} className=' group'>
                <Image
                className="rounded-lg object-cover h-full group-hover:opacity-10"
                src={web3}
              />
